...
<div class="container">
                ...
                <c:forEach items="${cart}" var="entry">
                    ...
                    <tr class="active">
                        <td width="60" width="40%">
                            <img src="${pageContext.request.contextPath }/${entry.product.pimage}" width="70"
                                 height="60">
                        </td>
                        <td width="30%"><a target="_blank">${entry.product.pname}</a></td>
                        <td width="20%">￥${entry.product.shopprice}</td>
    ...
    <div>
        <hr/>
        <form id="orderForm" class="form-horizontal" action="${pageContext.request.contextPath }/saveOrder"
              method="post"
            ...
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="inputPassword3" name="name"
                           placeholder="请输收货人" value="${activeuser.name}">
                </div>
            </div>
            <div class="form-group">
                ...
                <div class="col-sm-5">
                    <input type="text" class="form-control" id="confirmpwd" name="telephone"
                           placeholder="请输入联系方式" value="${activeuser.telephone }">
                </div>
            </div>
