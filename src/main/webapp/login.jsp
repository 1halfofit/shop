...
<head>
    ...
    <script type="text/javascript" charset="UTF-8">
        ...
        function cimg(obj) {
            ...
            obj.src = "servlet/code?time=" + Math.random();
        }
    ...
    <div class="row">
        ...
        <div class="col-md-5">
            <div
                ...
                <form class="form-horizontal" onsubmit="return check(this)" method="post"
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-6">
                            ...
                            <img src="servlet/code" id="img" onclick="cimg(this)">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="col-sm-offset-2 col-sm-10">
                            <div class="checkbox">
                                <label> <input type="checkbox" name="autoLogin" value="autoLogin" onclick="addrem()">
                                    自动登录
                                </label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; <label>
