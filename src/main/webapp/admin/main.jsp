<%@ page language="java" import="com.bo.bean.User" pageEncoding="UTF-8" isELIgnored="false" %>
...
<head>
	...
	<script type="text/javascript">
        ...
        function createTab(text, url) {
            ...
            //var iframe ="<iframe url='"+url+"'style=""></iframe>";
            $("#tt").tabs("add", {
                closable: true,
                title: text,
                href: url,
...
<div data-options="region:'west',title:'菜单导航栏',split:true" style="width:150px;">
	<ul id="mytree"></ul>
</div>
